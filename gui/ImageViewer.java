...
public class ImageViewer
{
    ...
    // Set the file chooser to start in the user's home directory
    ...
    private void openFile()
    {
        ...
        // Resize the frame to fit the newly loaded image
        frame.pack();
    }
    ...
    private void makeMenuBar(JFrame frame)
    {
        final int SHORTCUT_MASK =
            Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx(); // Use Ex for modern systems
        ...
        item = new JMenuItem("Threshold (3-Level)");
        item.addActionListener(new ActionListener() {
